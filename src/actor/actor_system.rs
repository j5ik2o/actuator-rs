...
use crate::actor::actor::ActorMutableBehavior;
...
impl ActorMutableBehavior for Logger {
  ...
  fn receive(&mut self, _: ActorContextRef<Self::Msg>, msg: Self::Msg) {
    match msg {
...
mod test {
  ...
  impl ActorMutableBehavior for TestActor {
    ...
    fn pre_start(&mut self, mut ctx: ActorContextRef<Self::Msg>) {
